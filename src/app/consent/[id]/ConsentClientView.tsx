...
import { ArrowLeft, ShieldAlert, Check, ShieldCheck, RefreshCw, User, Lock, Unlock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-center items-center py-12 px-4">
      <div className="max-w-xl w-full bg-slate-900/40 backdrop-blur-md border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-8">
        ...
        {saveStatus && (
          <div className="bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 px-4 py-2 rounded-xl text-xs flex items-center justify-between">
        ...
        <div className="bg-slate-950/50 border border-slate-800/80 rounded-2xl p-4 flex gap-3 text-slate-400">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-slate-500 leading-relaxed">
              Revocation is immediate and takes place off-chain. It blocks all web and API routes delivering audio or video files. The on-chain impact certificate is unmodified.
            </p>
          </div>
        </div>
